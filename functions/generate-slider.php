...
class theme_slider_page{
	...
	//constructor:	
	function theme_slider_page($info){
	$this->info=$info;
...
<form method="post" id="theme_options_form" class="theme_options_form">
	<input type="hidden" name="action" id="action" value="theme_save_slider" />
	<table class="widefat theme_slider theme_options">
		<thead>
			<tr>
				<th>Settings</th>
				<th>Description</th>
...
<?php
	...
	function save_options(){
		...
		if (isset($_POST['action']) && $_POST['action'] == 'theme_save_slider' ) {
