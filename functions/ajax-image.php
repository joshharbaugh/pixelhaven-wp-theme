<?php
//Save image via AJAX
add_action('wp_ajax_theme_ajax_upload', 'theme_ajax_image_upload'); //Add support for AJAX save

function theme_ajax_image_upload(){
...
add_action('wp_ajax_theme_ajax_remove', 'theme_ajax_image_remove'); //Add support for AJAX save

function theme_ajax_image_remove(){
	global $wpdb; //Now WP database can be accessed
