<?php
class Theme_Latest_Posts extends WP_Widget {
	...
	function Theme_Latest_Posts(){
		...
		$this->WP_Widget( 'theme_latest', 'Theme Posts', $widget_ops );
	}
...
?>
					<div>
							...
							<p><?php theme_excerpt(); ?></p>
							<span><?php _e('at', 'theme');?> <?php the_time('g:i A'); ?> <a href="<?php comments_link(); ?>"><?php comments_number(__( '0 Comments', 'theme' ), __( '1 Comment', 'theme' ), __( '% Comments', 'theme' ) ); ?></a></span>
					</div>
