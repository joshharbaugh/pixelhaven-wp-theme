<?php
class Theme_Tabbed extends WP_Widget {

	function Theme_Tabbed(){
		$widget_ops = array( 'classname' => 'theme_tabbed', 'description' => 'Show a tabbed widget with popular and recent posts, and comments.' );
		$this->WP_Widget( 'theme_tabbed', 'Theme Tabbed', $widget_ops );
	}
